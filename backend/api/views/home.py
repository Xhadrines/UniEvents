...
class HomeView(TemplateView):
    """
    View pentru pagina principală a aplicației.

    Această pagină afișează:
    - lista endpoint-urilor disponibile,
    - exemple de URL-uri API,
    - documentația rapidă pentru dezvoltatori.
    """

    # Template-ul HTML folosit pentru pagina principală.
    template_name = "home.html"

    def get_context_data(self, **kwargs):
        """
        Adaugă date suplimentare în contextul template-ului.

        Contextul este trimis către home.html
        și folosit pentru afișarea endpoint-urilor API.
        """

        # Obținem contextul de bază din TemplateView.
        context = super().get_context_data(**kwargs)

        # Lista endpoint-urilor disponibile în aplicație.
        #
        # Fiecare element conține:
        # - numele endpoint-ului
        ...
        # Returnăm contextul către template.
        return context
